 ...
 * Page Enseignants
 */
class PageEnseignants extends JPanel implements ActionListener{
...
//Tableaux
    ...
    /**
     * Constructeur de la page 'Enseignants'
     * @param utilisateurCo Correspond à l'utilisateur connecté
     */
    public PageEnseignants(Utilisateur utilisateurCo)
    {
        //Initialisation user
    ...
    public void initPanelEDTNord()
    {
        ...
        labelNom = new JLabel("Entrez le nom d'un enseignant :");
        textFieldNom = new JTextField();
        textFieldNom.setPreferredSize(new Dimension(200, 25));
        
        //Initialisation recherche par liste
        labelListe = new JLabel("Cherchez depuis la liste des enseignants :");
        ...
        for(int i=0; i<tabChoixEnseignant.size(); i++){
            String temp = tabChoixEnseignant.get(i).getUtilisateur().getNom().toUpperCase();
...
//PANEL RECAP
    ...
    public void initPanelRecapNord()
    {
        ...
        //Initialisation recherche par nom
        labelNom2 = new JLabel("Entrez le nom d'un enseignant :");
...
//PANEL ANNULES
    ...
    public void initPanelAnnulesNord()
    {
        ...
        //Initialisation recherche par nom
        labelNom3 = new JLabel("Entrez le nom d'un enseignant :");
     ...
     * @return JPanel
     */
    public JPanel dessinerEDT(Enseignant enseignant, int numSemaine, boolean annule)
    {
        JPanel panelCentre = new JPanel();
        ...
        ArrayList<Seance> maSemaine = donnees.getSeanceSemaineEnseignant(numSemaine, enseignant.getUtilisateur().getNom() + " " + enseignant.getUtilisateur().getPrenom());
    ...
    //Check choix de l'utilisateur sur le type de recherche : par nom / depuis liste
            ...
            if(comboChoix.getSelectedIndex() == 0)
            {
                ...
                if(nomProfSelect.length() != 0){
                    ...
                    if(enseignantExiste){
                        ...
                        panelEDTCenter.add(dessinerEDT(enseignantSelect, semaineSelect, false), BorderLayout.CENTER);
                    }
                }
            }
    ...
    //COURS ANNULES
        if(source == chercherAnnules)
        {
            ...
            String nomProfSelect = (String)textFieldNom3.getText();
            ...
            if(nomProfSelect.length() != 0){
                ...
                if(enseignantExiste){
                    ...
                    panelEDTCenter.revalidate();
                    panelEDTCenter.repaint();
                    panelEDTCenter.add(dessinerEDT(enseignantSelect, semaineSelect, true), BorderLayout.CENTER);
                }
            }
